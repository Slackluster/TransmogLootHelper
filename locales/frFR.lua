...
L.SETTINGS_ICON_ANIMATE_DESC =          "Afficher une jolie animation tourbillonnante sur les icônes des objets utilisables / apprenables."
...
L.SETTINGS_ICON_NEW_MOG_DESC =          "Afficher une icône pour indiquer qu'une source d'apparence d'objet n'est pas apprise."
