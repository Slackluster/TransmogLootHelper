...
L.WINDOW_HEADER_FILTERED_DESC =         "|r" .. app.IconRMB .. "|cffFFFFFF : debug cet objet\n|rMaj " .. app.IconLMB .. "|cffFFFFFF : lier l'objet\n|rMaj " .. app.IconRMB .. "|cffFFFFFF : supprimer l'objet"
...
L.SETTINGS_ICON_ANIMATE_DESC =          "Afficher une animation sur les objets apprenables / utilisables."
L.SETTINGS_ICONLEARNED =                "Icône appris"
L.SETTINGS_ICONLEARNED_DESC =           "Afficher une icône pour les objets déjà appris."
...
L.SETTINGS_BINDTEXT_DESC =              "Afficher un indicateur pour LqÉ, Lq BoE, LqA et LaB."
...
L.SETTINGS_COLLECTION_MODE_DESC =       "Définit quand " .. app.NameShort .. " doit afficher les nouveaux transmogrifications obtenues par d'autres."
L.SETTINGS_MODE_APPEARANCES =           "Apparences"
L.SETTINGS_MODE_APPEARANCES_DESC =      "Afficher les objets uniquement s'ils possèdent une nouvelle apparence."
L.SETTINGS_MODE_SOURCES =               "Sources"
L.SETTINGS_MODE_SOURCES_DESC =          "Afficher les objets s'ils constituent une nouvelle source, y compris pour des apparences déjà connues."
...
L.SETTINGS_WHISPER_CUSTOMIZE_DESC =     "Personnalise le message chuchoté"
...
L.SETTINGS_CATALYST_DESC =              "Maintenez Maj enfoncé pour catalyser instantanément un objet, sans attendre les 5 secondes."
L.SETTINGS_VAULT =                      "Coffre hebdomadaire instantané"
L.SETTINGS_VAULT_DESC =                 "Maintenez Maj enfoncé pour recevoir instantanément votre récompense du Coffre hebdomadaire, sans attendre les 5 secondes."
