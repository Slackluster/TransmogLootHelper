...
L.SETTINGS_RECIPE_PERCHAR =              "Отслеживать для каждого персонажа"
L.SETTINGS_RECIPE_PERCHAR_DESC =         "Показывать уже изученные рецепты как доступные для изучения альтами."
